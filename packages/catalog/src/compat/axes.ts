...
export const AXES: Readonly<Record<string, AxisDef>> = {
	...
	"requires-native-tools": { key: "requiresNativeTools", set: "catalog", shape: "scalar" },
	"requires-tool-free-history-for-tool-opt-out": {
		key: "requiresToolFreeHistoryForToolOptOut",
		set: "catalog",
		shape: "scalar",
	},
	"preserves-max-output-tokens": { key: "preservesMaxOutputTokens", set: "catalog", shape: "scalar" },
